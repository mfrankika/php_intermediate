...
//injecao de dependencia - criar class e inserir a conexao dentro dela
...
<form method="GET">
	<select name="ano">
		<?php 
		//preenchimento select ano começo:ano atual descrecendo ate 2000
...
<?php
// receber os dados escolhido do select - ano/mes
if(empty($_GET['ano'])) {
	exit;
}
...
//traz as reservas entre as datas escolhidas
$lista = $reservas->getReservas($data_inicio, $data_fim);
foreach($lista as $item) {
	//mostrar data no padrao brasil
